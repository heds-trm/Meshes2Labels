...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    TCLAP::CmdLine cmd(
      ...
      "2 files will be produced containing the (inverse) transformation from "
      ...
      "Tet vtkUnstructuredGrid are also supported by extracting the surface as a polydata.\n"
      "WARNING: Make sure that your triangular meshes (or the surface of tet mesh) are fully triangular and closed. The app "
