...
public:
    ...
    void  dump_vertex( double  sel1, double  sel2, double  sel3 ) const {
		...
		// jschmid addition: routine to get points instead of dumping them...
		void get_vertex( double sel1, double sel2, double sel3, gdiam_point_t& pnt ) const
		{
			gdiam_real  coef1, coef2, coef3;
